...
let mainWindow;
// let sshClient: Client | null = null; // Temporarily commented out
// let sshStream: Client.Shell | null = null; // Temporarily commented out
const createWindow = () => {
    ...
    mainWindow = new electron_1.BrowserWindow({
        ...
        webPreferences: {
            ...
            // contextIsolation and nodeIntegration defaults are secure (true and false)
        },
    });
    ...
    mainWindow.on('closed', () => {
        // Close SSH connection if it exists - Temporarily commented out
        // if (sshStream) {
        //   sshStream.end();
        // }
        // if (sshClient) {
...
// --- IPC Handlers --- (Temporarily commenting out SSH related handlers)
